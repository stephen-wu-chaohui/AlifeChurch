...
export default function GroupsScreen() {
	...
	const fetchData = async () => {
		...
		try {
			const token =
				"EAANMfBlL3l4BACrDFxc9Jv6ZAInYVHm0lAZAlqIBWcZCz042u4bH0XbsQzfpnKCmCsNBW53xzLqZBiwg4B2xDk6lkuLOxXKS92GaU8O7ZAXDyyEF66bE2lnNeLAeqnpVInnndiQLv3oDCWXBN3LbEejcjF6DZBNahpK6yIfRHji70J15q3NZC7h";
	...
	const renderItem = data => (
		<ListItem
			...
			key={data.item.id}
			leftAvatar={{
				source: { uri: data.item.cover.source },
				rounded: false
			}}
